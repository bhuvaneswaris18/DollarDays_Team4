...
import com.dollardays.pages.OrderHistoryPage;
...
public class OrderHistoryTestcase extends BaseTest {
	...
	@DDDataProvider(datafile = "testdata/OrderHistory.xlsx", sheetName = "Sheet2",  testcaseID = "TC1", runmode = "Yes")
    ...
    public void TC_01_orderHistory(Hashtable<String, String> datatable) throws InterruptedException, UnsupportedEncodingException, GeneralSecurityException
	{
		...
		Thread.sleep(1000);	
		OrderHistoryPage orderhis=new OrderHistoryPage(driver);
	    ...
	    orderhis.smonthpage();
	    ExtentTestManager.getTest().log(Status.PASS, "Step 5  : Get the month");
	
		Thread.sleep(5000);
		
		orderhis.getstartdate().click();
		ExtentTestManager.getTest().log(Status.PASS, "Step 6  : Click on the start date");
		Thread.sleep(500);
		
		orderhis.enddatefield().click();
		ExtentTestManager.getTest().log(Status.PASS, "Step 7  : Click on the end date field");
		Thread.sleep(5000);
		
		orderhis.emonthpage();
		ExtentTestManager.getTest().log(Status.PASS, "Step 8  : Get the month");
		Thread.sleep(5000);
		
		
		orderhis.getenddate().click();
		ExtentTestManager.getTest().log(Status.PASS, "Step 9  : Click on the end date ");
		
		orderhis.getpopup().click();
	...
	@DDDataProvider(datafile = "testdata/OrderHistory.xlsx", sheetName = "Sheet2",  testcaseID = "TC2", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
