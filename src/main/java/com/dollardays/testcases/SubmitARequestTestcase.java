...
/*
	...
	*/
	...
	@DDDataProvider(datafile = "testdata/SubmitARequest.xlsx", sheetName = "SubmitARequest",  testcaseID = "TC1", runmode = "yes")
		@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
		public void enteringthedata(Hashtable<String, String> datatable) throws Exception{
			...
			SubmitARequestPage sr=new SubmitARequestPage(driver);
