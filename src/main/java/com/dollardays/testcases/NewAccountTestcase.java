...
public class NewAccountTestcase extends BaseTest
{
	
	 @DDDataProvider(datafile = "testdata/NewAccount.xlsx", sheetName = "CreateAccount",  testcaseID = "", runmode = "Yes")
	 ...
	 public void createlogin(Hashtable<String, String> datatable) throws Exception
 {
	...
	com.dollardays.pages.NewAccountPage create_acc = new com.dollardays.pages.NewAccountPage(driver);
