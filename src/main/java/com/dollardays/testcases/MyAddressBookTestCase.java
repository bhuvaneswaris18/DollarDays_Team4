...
public class MyAddressBookTestCase extends BaseTest{
	...
	@DDDataProvider(datafile = "testdata/TestData_AddressBook.xlsx", sheetName = "Sheet1",  testcaseID = "", runmode = "Yes")
	...
	public void login(Hashtable<String, String> datatable) throws Exception {	
		...
		// Execute the LOGIN TestCase by passing the login credentials via Data Driven Design and not decrypt
	...
	@DDDataProvider(datafile = "testdata/TestData_AddressBook.xlsx", sheetName = "Sheet2",  testcaseID = "", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
